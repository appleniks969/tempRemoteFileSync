        ...
        if (intent.action == Intent.ACTION_BOOT_COMPLETED || 
            ...
            GlobalScope.launch(Dispatchers.IO) {
                try {
                    ...
                    val configRepository = com.sync.filesyncmanager.domain.ConfigRepository(preferenceStorage)
                    val config = configRepository.getSyncConfig() ?: SyncConfig(
                    ...
                    if (scheduler.javaClass.methods.any { it.name == "schedulePeriodic" }) {
                        scheduler.javaClass.getMethod("schedulePeriodic", Long::class.java)
